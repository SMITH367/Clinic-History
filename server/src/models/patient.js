...
const getPatients = "SELECT patients.identification, patients.name, patients.last_name, patients.identificationType, classes.name as type, patients.birthday FROM patients, classes WHERE patients.class_patient = classes.class_id";
